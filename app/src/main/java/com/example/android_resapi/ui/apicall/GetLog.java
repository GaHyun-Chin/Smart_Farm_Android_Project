...
public class GetLog extends GetRequest {
    ...
    protected ArrayList<Tag> getArrayListFromJSONString(String jsonString) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Tag thing = new Tag(jsonObject.getString("soil moisture"),
    ...
    class Tag {
        ...
        public Tag(String sm,String l,String temp,String h,String time) {
            temperature = temp;
            soil_moisture=sm;
            light=l;
            humidity=h;
        ...
        public String toString() {
            return String.format("[%s] Temperature: %s, Humidity: %s, Soil_Moisture: %s, Light: %s", timestamp, temperature, humidity, soil_moisture, light);
        }
    }
}
